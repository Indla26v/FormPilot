...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-white relative overflow-hidden">
      {/* Background AI Mesh & Luminous Glow (Nanobanana Style) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-90">
        <Image
          src="/images/bg-contact.jpg"
          alt="Luminous Contact Mesh Background"
          fill
          className="object-cover object-center"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-transparent to-white/95"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 text-base sm:text-lg">
            Have questions about local Ollama integration, enterprise deployments, or feature requests? We are here to help.
          </p>
        </div>

        {/* Contact Grid: Direct Info Card & Interactive Form Card */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Direct Support Card */}
            <div className="bg-slate-900/95 backdrop-blur-md rounded-3xl p-7 sm:p-8 text-white border border-slate-800 shadow-2xl space-y-6">
