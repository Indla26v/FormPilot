...
export default function FeedbackSection() {
  ...
  return (
    <section id="feedback" className="py-20 md:py-28 bg-white relative overflow-hidden">
      {/* Background AI Mesh & Luminous Glow (Nanobanana Style) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-90">
        <Image
          src="/images/bg-feedback.jpg"
          alt="Luminous Feedback Mesh Background"
          fill
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-800 text-xs font-bold uppercase tracking-wider">
            ...
            <span>Community & User Feedback</span>
          </div>
        ...
        {/* Feedback Card */}
        <div className="bg-white/95 backdrop-blur-md rounded-3xl p-7 sm:p-10 border border-slate-200 shadow-2xl space-y-8">
